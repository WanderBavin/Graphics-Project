...
public class EmissiveRectangle implements Shape{
	...
	public EmissiveRectangle(Transformation transformation,World world){
	...
	public Vector getHardcodedNormal() {
